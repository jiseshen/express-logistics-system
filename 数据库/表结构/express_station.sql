...
CREATE TABLE `station` (
  `sid` int NOT NULL AUTO_INCREMENT COMMENT '驿站编号',
  `slocation` int NOT NULL COMMENT '驿站所在区域',
  `saddress` varchar(200) NOT NULL COMMENT '驿站地址',
  PRIMARY KEY (`sid`),
  KEY `slocation_index` (`slocation`)
